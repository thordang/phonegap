...
fabric.Collection = {
  ...
  insertAt: function (object, index, nonSplicing) {
	...
	//this.centerObjectX(this._objects[index]);
	//this._objects[index].setCoords();
	this._objects[index].selectable  = true;
	this._objects[index].originX  = "center";
	this._objects[index].originY  = "center";
    this.renderOnAddRemove && this.renderAll();
    return this;
  },
...
(function () {
  ...
  fabric.StaticCanvas = fabric.util.createClass(/** @lends fabric.StaticCanvas.prototype */ {
    ...
    __setBgOverlayImage: function(property, image, callback, options) {
		//  this.upperCanvasEl.style.background
		//console.log(image);
		/*Note by Tai
		console.log(this.upperCanvasEl.style.width);
		console.log(this.upperCanvasEl.style.height);*/
    ...
    _onObjectAdded: function(obj) {
	  ...
	  if(this._objects.length > 0)
			...
			{
				this.centerObjectX(this._objects[i]);
			}
				} */
    },
	...
	//	console.log('sdasd');
		//console.log(this.width + 'pxx');
		//console.log(this.height + 'pxx');
	//	console.log(this.overlayColor.offsetX + 'pxxx');
		//console.log(this.overlayColor.offsetX + 'pxxx');
		//console.log(this.overlayColor);
      ...
      if (this.overlayImage) {
		  this.overlayImage.width = this.width;
		   this.overlayImage.height = this.height;
 ...
 centerObjectX: function(object) {
    ...
    _toObjectMethod: function (methodName, propertiesToInclude) {
      ...
      var data = {
        ...
        price_background: this.price_background,
        w_canvas: this.width,
        h_canvas: this.height
      };
	  ...
	  if (this.backgroundImage) {
        ...
        data.price_background = this.price_background;
      }
      return data;
    },
...
(function() {
  ...
  fabric.Canvas = fabric.util.createClass(fabric.StaticCanvas, /** @lends fabric.Canvas.prototype */ {
    ...
    */
	...
	//  this.upperCanvasEl.style.background = '';
	//  this.upperCanvasEl.style.backgroundColor = '';
	
	 // alert(this.upperCanvasEl.style.cssText);
	 //  console.log(this.upperCanvasEl.style.CSSStyleDeclaration['background']);
	 //  console.log(this.upperCanvasEl.style.CSSStyleDeclaration['backgroundColor']);
	  ...
	  this.upperCanvasEl.style.background = '';
	  this.upperCanvasEl.style.backgroundColor = '';
	//  console.log(this.lowerCanvasEl);
	//   console.log(this.upperCanvasEl);
	// this.upperCanvasEl.style.backgroundColor = "#227755";
	// console.log(this.upperCanvasEl);
	// console.log(this.upperCanvasEl.style);
	 //console.log(this.upperCanvasEl.style.backgroundColor);
	// console.log(this.upperCanvasEl.style.cssText);
...
(function(){
  ...
  fabric.util.object.extend(fabric.Canvas.prototype, /** @lends fabric.Canvas.prototype */ {
    ...
    _beforeTransform: function(e, target) {
      ...
      if(target.isbackground==true&&target.active==true)
        this.deactivateAll();
    },
...
json_api: function(json){
		  
    if (!json) return;
    var serialized = JSON.parse(json);
	
	  var t = paintAppGlobal.canvas;
	 var cheight = t.height;
	 var cwidth = t.width;
	
		  var scale = Math.min(cheight/serialized.h_canvas , cwidth/serialized.w_canvas);
		  var scalex = cwidth/serialized.w_canvas;
		  var scaley = cheight/serialized.h_canvas;
		 
	 for(var i = 0; i< serialized.objects.length; i++){
		 if(serialized.objects[i].type != 'image' )
		 {
			 serialized.objects[i].isbackground = false;
		 }
		 
			  serialized.objects[i].scaleX = serialized.objects[i].scaleX*scale;
			   serialized.objects[i].scaleY = serialized.objects[i].scaleY*scale;
	
				 serialized.objects[i].top =  serialized.objects[i].top*scaley;
				  serialized.objects[i].left =  serialized.objects[i].left*scalex;
		
	  }
	  if (document.getElementById('ImageSelect-2'))
	             {			
	   for(var i = 0; i< serialized.objects.length; i++)
	   {
	   serialized.objects[i].selectable = true;
	    serialized.objects[i].groupLayer = 0;
	   }
	}
 ...
 loadFromJSON_api: function (json, callback, reviver) {
	...
	//console.log('jjjjjjjjjjjjjjjjjjjjjjjjjjj');
	  listGroup1 = [new GroupLayer(true, 0), new GroupLayer(false, 1), new GroupLayer(false, 2), new GroupLayer(false, 3), new GroupLayer(false, 4), new GroupLayer(false, 5)];
 listGroup2 = [new GroupLayer(true, 0), new GroupLayer(false, 1), new GroupLayer(false, 2), new GroupLayer(false, 3), new GroupLayer(false, 4), new GroupLayer(false, 5)];
	if(layer == 1)
	{
	  ...
	  for(var i = 0; i< serialized.objects.length; i++){
		  ...
		  if(temp < serialized.objects[i].groupLayer)
		  temp = serialized.objects[i].groupLayer;
	  }
	  
	
	 for(var i = 0; i< enableLayers_1.length; i++){
		 listGroup1[i].enable = true;
      $j('#block-layer').append('<div class="layer-block-item">  <div ondblclick="changeLayerName(this);" onclick="selectLayer(' + enableLayers_1[i].id + ');" id="layer-' + enableLayers_1[i].id + '" class="even layer-item selected layer_left"><a href="javascript:void(0);">' + enableLayers_1[i].name + '</a></div>   <div class="layer_eye"><a href="javascript:void(0);" class="eye eye-on"><img onclick="changeVisible(this, ' + enableLayers_1[i].id + ');" src="http://www.peopleschoiceapparel.com/media/bss_design/eye-on.png" height="" /></a></div>    <div style="clear: both;"></div>  </div>');
      ...
      if(enableLayers_1.length == 1){
        $j('#layer-trash').hide();
        $j('#layer-add').show();
      }else if(enableLayers_1.length == 6){
        $j('#layer-trash').show();
        $j('#layer-add').hide();
      }else{
        $j('#layer-add').show();
	 ...
	 // $j('#block-layer').html('');
	   for(var i = 0; i< serialized.objects.length; i++){
	    ...
	    for(var i = 0; i< enableLayers_2.length; i++){
			 listGroup2[i].enable = true;
       $j('#block-layer').append('<div class="layer-block-item">  <div ondblclick="changeLayerName(this);" onclick="selectLayer(' + enableLayers_2[i].id + ');" id="layer-' + enableLayers_2[i].id + '" class="even layer-item selected layer_left"><a href="javascript:void(0);">' + enableLayers_2[i].name + '</a></div>   <div class="layer_eye"><a href="javascript:void(0);" class="eye eye-on"><img onclick="changeVisible(this, ' + enableLayers_2[i].id + ');" src="http://www.peopleschoiceapparel.com/media/bss_design/eye-on.png" height="" /></a></div>    <div style="clear: both;"></div>  </div>');
      ...
      if(enableLayers_2.length == 1){
        $j('#layer-trash').hide();
        $j('#layer-add').show();
      }else if(enableLayers_2.length == 6){
        $j('#layer-trash').show();
        $j('#layer-add').hide();
      }else{
        $j('#layer-add').show();
	...
	{
	if( serialized.objects[i].type == "image")
         serialized.objects[i].isbackground = true;
		// this.setBackgroundImage(serialized.objects[i].src);
	}
...
(function(global) {
  ...
  fabric.Object = fabric.util.createClass(/** @lends fabric.Object.prototype */ {
    ...
    stateProperties:  (
      ...
      'angle isbackground selectable groupLayer nameLayer opacity fill fillRule shadow clipTo visible backgroundColor price'
    ).split(' '),
