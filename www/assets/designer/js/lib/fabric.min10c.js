...
Cufon.registerEngine('vml', (function() {
  ...
  fabric.document.write('<style type="text/css">' +
    ...
    '@media screen{' +
      ...
      '.cufon-vml{display:inline-block;position:relative;vertical-align:left}' +
...
(function() {
  ...
  var InteractiveMethods = /** @scope fabric.Canvas.prototype */ {
    ...
    _translateObject: function (x, y) {
      ...
      var aO = target;
      var aB = [aO.top-aO.currentHeight/2, aO.left-aO.currentWidth/2, aO.top+aO.currentHeight/2, aO.left+aO.currentWidth/2]
      var rangeX = aO.currentWidth-(aO.bound[3]-aO.bound[1]); rangeX = [aO.bound[1]-2, aO.bound[1]+2-rangeX];
      var rangeY = aO.currentHeight-(aO.bound[2]-aO.bound[0]); rangeY = [aO.bound[0]-2, aO.bound[0]+2-rangeY];

      if (!target.get('lockMovementX')) {
        if((x-this._currentTransform.offsetX-(aO.currentWidth/2))<rangeX[0])
          if((x-this._currentTransform.offsetX-(aO.currentWidth/2))>rangeX[1]){
            target.set('left', x - this._currentTransform.offsetX);
          }
      }

      if (!target.get('lockMovementY')) {
        if((y-this._currentTransform.offsetY-(aO.currentHeight/2))<rangeY[0])
          if((y-this._currentTransform.offsetY-(aO.currentHeight/2))>rangeY[1]){
    ...
    _scaleObject: function (x, y, by) {
      ...
      if (by === 'equally' && !lockScalingX && !lockScalingY) {
        ...
        rangeX = [aO.bound[1]-2, aO.bound[3]+2];
        rangeY = [aO.bound[0]-2, aO.bound[2]+2];

        if(varOBJ.fixX==null)
          if(t.originX === 'left')
            varOBJ.fixX = t.left+target.width*t.original.scaleX/2;
          else
            varOBJ.fixX = t.left-target.width*t.original.scaleX/2;
        if(varOBJ.fixY==null)
          if(t.originY === 'top')
            varOBJ.fixY = t.top+target.height*t.original.scaleX/2;
          else
            varOBJ.fixY = t.top-target.height*t.original.scaleX/2;
        ...
        var done = false;
        if(t.originY === 'top' && done == false)
          if((varOBJ.fixY+(varOBJ.movY-varOBJ.oldY))<rangeY[1]){
              newScaleX = varOBJ.acpSx;
              newScaleY = varOBJ.acpSy;
              done = true;
            }
          else{
            varOBJ.acpSx = newScaleX;
            varOBJ.acpSy = newScaleY;
          }
        if(t.originY === 'bottom' && done == false)
          if((varOBJ.fixY+(varOBJ.movY-varOBJ.oldY))>rangeY[0]){
              newScaleX = varOBJ.acpSx;
              newScaleY = varOBJ.acpSy;
              done = true;
            }
        ...
        if(t.originX === 'left' && done == false)
          if((varOBJ.fixX+(varOBJ.movX-varOBJ.oldX))<rangeX[1]){
              newScaleX = varOBJ.acpSx;
              newScaleY = varOBJ.acpSy;
              done = true;
            }
        ...
        if(t.originX === 'right' && done == false)
          if((varOBJ.fixX+(varOBJ.movX-varOBJ.oldX))>rangeX[0]){
              console.log((varOBJ.fixX+(varOBJ.movX-varOBJ.oldX))+' > '+rangeX[0])
              newScaleX = varOBJ.acpSx;
              newScaleY = varOBJ.acpSy;
              done = true;
            }
    ...
    */
    ...
    _createUpperCanvas: function () {
      ...
      this.upperCanvasEl.id = this.lowerCanvasEl.id+'-upper-canvas';
